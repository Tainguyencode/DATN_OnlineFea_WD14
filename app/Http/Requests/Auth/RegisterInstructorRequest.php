...
class RegisterInstructorRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'certificates.array' => 'Danh sách tệp chứng chỉ không hợp lệ.',
            'certificates.max' => 'Bạn chỉ có thể tải lên tối đa 10 tệp chứng chỉ.',
            'certificates.*.file' => 'Mỗi tệp chứng chỉ phải là một tệp hợp lệ.',
            'certificates.*.mimes' => 'Mỗi chứng chỉ chỉ chấp nhận định dạng PDF, JPG, JPEG hoặc PNG.',
            'certificates.*.max' => 'Dung lượng mỗi chứng chỉ tối đa là 5MB.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'cv' => 'tệp CV',
            'certificates' => 'danh sách chứng chỉ',
