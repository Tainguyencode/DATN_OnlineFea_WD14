...
class AuthController extends Controller
{
    ...
    public function register(string $role, RegisterRequest $request, AuthService $authService, EmailVerificationService $emailVerificationService): RedirectResponse
    {
        abort_unless(in_array($role, ['student', 'instructor'], true), Response::HTTP_NOT_FOUND);
