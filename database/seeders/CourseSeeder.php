    ...
    public function run(): void
    {
        ...
        $courses = [
            ...
            [
                ...
                'instructor_id' => 2,
                'category_id' => $categoryIds['web'],
                'title' => 'Lập trình di động Flutter từ cơ bản',
                'slug' => Str::slug('Lập trình di động Flutter từ cơ bản'),
                'description' => 'Khóa học lập trình ứng dụng di động đa nền tảng iOS & Android với Flutter và Dart.',
                'objectives' => 'Nắm vững ngôn ngữ Dart, Widget, State Management trong Flutter, và xây dựng ứng dụng di động kết nối API.',
                'thumbnail' => 'flutter_beginner.png',
                'preview_video' => null,
                'level' => 'beginner',
                'price' => 699000.00,
