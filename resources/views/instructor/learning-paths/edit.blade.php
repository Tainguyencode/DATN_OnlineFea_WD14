<x-instructor-layout title="Chỉnh sửa Lộ trình học tập - FEA Instructor" page-title="Chỉnh sửa lộ trình học tập" :back-url="route('instructor.learning-paths.index')">
