...
@php
    $cartCount = \App\Models\Cart::where('user_id', Auth::id())->first()?->courses()->count() ?? 0;
    $cartLabel = $cartCount > 0 ? "Giỏ hàng ($cartCount)" : "Giỏ hàng";
    ...
    $menu = [
        ...
        [
            'route' => 'student.recently-viewed.index',
            'label' => 'Đã xem gần đây',
            'active' => ['student.recently-viewed.*'],
        ...
        [
            ...
            'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.539 1.118l-2.8-2.034a1 1 0 00-1.176 0l-2.8 2.034c-.783.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118l-2.8-2.034c-.783-.57-.38-1.81.588-1.81H9.03a1 1 0 00.95-.69l1.07-3.292z"/></svg>'
        ],
        [
            'route' => 'student.cart',
            'label' => $cartLabel,
        ...
        [
            ...
            'active' => ['favorites.*', 'student.wishlist'],
