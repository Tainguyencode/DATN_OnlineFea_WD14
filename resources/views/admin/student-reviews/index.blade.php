                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        @forelse($reviews as $review)
                            <tr class="align-top">
                                ...
                                <td class="px-4 py-4"><div class="flex flex-col items-end gap-2"><a href="{{ route('admin.student-reviews.show', $review) }}" class="font-bold text-indigo-700 hover:underline dark:text-indigo-300">Chi tiết</a></div></td>
                            </tr>
                        @empty
