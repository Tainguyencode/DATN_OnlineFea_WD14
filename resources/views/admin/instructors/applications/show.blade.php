        ...
        <div class="flex items-center justify-between relative z-10">
            ...
            <div class="flex items-center gap-3">
                @if($application->instructor_status !== 'approved')
                    <button type="button" @click="approveModal = true" class="cursor-pointer rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg transition hover:bg-emerald-700 active:scale-95">
