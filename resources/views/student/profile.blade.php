                ...
                <form method="POST" action="{{ route('student.profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name', $user->name) }}"
                               class="w-full rounded-xl border px-4 py-2.5 text-sm outline-none @error('name') border-rose-500 focus:ring-2 focus:ring-rose-500 @else border-slate-300 focus:ring-2 focus:ring-[#0056D2] @enderror">
                    ...
                    <div>
                        ...
                        <input id="username" type="text" name="username" value="{{ old('username', $user->username) }}"
                               class="w-full rounded-xl border px-4 py-2.5 text-sm outline-none @error('username') border-rose-500 focus:ring-2 focus:ring-rose-500 @else border-slate-300 focus:ring-2 focus:ring-[#0056D2] @enderror">
                    ...
                    <div>
                        ...
                        <input id="phone" type="text" name="phone" value="{{ old('phone', $user->phone) }}"
                               class="w-full rounded-xl border px-4 py-2.5 text-sm outline-none @error('phone') border-rose-500 focus:ring-2 focus:ring-rose-500 @else border-slate-300 focus:ring-2 focus:ring-[#0056D2] @enderror">
                    ...
                    <div>
                        ...
                        @error('bio') <p class="mt-1 text-xs font-semibold text-rose-600">{{ $message }}</p> @enderror
                    </div>
                ...
                <form method="POST" action="{{ route('student.profile.password.update') }}" class="mt-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input id="current_password" type="password" name="current_password" autocomplete="current-password"
                               class="w-full rounded-xl border px-4 py-2.5 text-sm outline-none @error('current_password') border-rose-500 focus:ring-2 focus:ring-rose-500 @else border-slate-300 focus:ring-2 focus:ring-[#0056D2] @enderror">
                    ...
                    <div>
                        ...
                        <input id="password" type="password" name="password" autocomplete="new-password"
                               class="w-full rounded-xl border px-4 py-2.5 text-sm outline-none @error('password') border-rose-500 focus:ring-2 focus:ring-rose-500 @else border-slate-300 focus:ring-2 focus:ring-[#0056D2] @enderror">
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" type="password" name="password_confirmation" autocomplete="new-password"
                               class="w-full rounded-xl border px-4 py-2.5 text-sm outline-none @error('password_confirmation') border-rose-500 focus:ring-2 focus:ring-rose-500 @else border-slate-300 focus:ring-2 focus:ring-[#0056D2] @enderror">
