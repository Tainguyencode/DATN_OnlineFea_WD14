            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-center">
                <div class="space-y-4">
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        @endif
                        @if($learningPath->salary_range)
                            <span class="inline-flex items-center gap-1 rounded-full border border-emerald-400/30 bg-emerald-500/10 px-3 py-1 text-xs font-bold text-emerald-300">
                                💼 Mức lương: {{ $learningPath->salary_range }}
                            </span>
                        @endif
                    </div>
