                ...
                <div class="ml-auto flex shrink-0 items-center gap-2">
                    ...
                    @auth
                        ...
                        <a href="{{ route('study-groups.index') }}" 
                           class="relative rounded-lg p-2 text-slate-600 transition duration-200 hover:bg-slate-50 hover:text-[#0056D2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-300 flex items-center justify-center cursor-pointer" 
                           title="Nhóm học tập"
